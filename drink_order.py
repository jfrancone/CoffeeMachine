...
def order_drink(MENU, resources):
    ...
    while not valid_request:
        order_string = input('What would you like? (espresso/latte/cappuccino): \n').lower()
        #print(order_string)
        if order_string == 'report' or order_string == 'off' or order_string == 'latte' or order_string == 'espresso' or order_string == 'cappuccino':
            valid_request = True
